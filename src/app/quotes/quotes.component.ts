...
export class QuotesComponent implements OnInit {
  property:Properties[]= [
    ...
    new Properties(` "That which does not kill us makes us stronger."`, `~Friedrich Nietzsche` ,new Date(2020,4,1),0,0,),
    new Properties(` "If you think you can do a thing or think you can’t do a thing, you’re right."`, `Henry Ford`,new Date(2020,4,1),0,0,),
    new Properties(` "Genius is eternal patience"`, `~MichelAngelo`,new Date(2020,4,1),0,0,),
    new Properties(` "Better to die standing than to live on your knees."`, `~Ernesto “Che” Guevara`,new Date(2020,4,1),0,0,),
